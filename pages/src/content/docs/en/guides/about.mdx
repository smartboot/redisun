...
| `HMSET` | Set multiple field-value pairs in a hash table simultaneously | [HmSetCommand](https://github.com/smartboot/redisun/blob/master/src/main/java/tech/smartboot/redisun/cmd/HmSetCommand.java) | Batch set hash fields |
| `HMGET` | Get the values of one or more specified fields in a hash table | [HmGetCommand](https://github.com/smartboot/redisun/blob/master/src/main/java/tech/smartboot/redisun/cmd/HmGetCommand.java) | Batch get hash field values |
